...
export function getAllPostIds() {
  const fileNames = [ { "id" : "50", "title" : "Title 50", "contentDeMoi" : "content 50" } , { "id" : "51", "title" : "Title 51", "contentDeMoi" : "content 51" }, { "id" : "52", "title" : "Title 52", "contentDeMoi" : "content 52" } ];
  ...
  return fileNames.map((fileName) => {
    return {
      params: {
        ...
        contentDeMoi : fileName.contentDeMoi
      },
    };
  });
}
